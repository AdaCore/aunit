...
with AUnit.Tests.Test_Cases.Assertions;
with AUnit.Tests.Test_Suites;
...
generic
   ...
   Routine_Name_Size : Natural;        --  Max size of a test routine
                                       --  description
package AUnit.Framework is
   package Test_Results is
     new AUnit.Test_Results
   ...
   package Tests is new AUnit.Tests (Test_Results);
   ...
   generic
      with function Suite return Test_Suites.Test_Suite_Access;
   package Harness is
      procedure Run;
   end Harness;
