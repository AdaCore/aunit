...
package AUnit.Test_Results is
   ...
   package Message_List is new AUnit_Lists (Message_String);
   type Message_List_Access is access all Message_List.List;

   function Get_Packages (R : Result) return Message_List_Access;
